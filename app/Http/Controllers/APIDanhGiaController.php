...
class APIDanhGiaController extends Controller
{
    ...
    public function themMoi()
    {
        ...
        $so_sao_trung_binh = DanhGia::where('dien_thoai_id', request('dien_thoai_id'))->avg('so_sao');

        $apidanh_gia = DanhGiaResource::collection($lst_danh_gia);
        return $this->apiResource(true, 200, [
            'so_sao_trung_binh' => floor($so_sao_trung_binh),
            'danh_gia' => $apidanh_gia,
        ], "Danh sách đã thêm mới đánh giá");
    }
