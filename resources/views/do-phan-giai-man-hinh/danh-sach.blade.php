        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Cổng Sạc</h1>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Cổng Sạc</a></li>
                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <div class="btn" style="position: relative;left: 78%;">
                                        <a href="{{ route('do-phan-giai-man-hinh.them-moi') }}" class="btn btn-primary-light ">Thêm
                                            mới</a>
                                    </div>
                                    <!-- form tim kiem -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table editable-table table-nowrap table-bordered table-edit">
                                            ...
                                            <tbody>
                                                @foreach ($lst_dophangiaimanhinh as $dophangiaimanhinh)
                                                    <tr>
                                                        <td>{{ $dophangiaimanhinh->ten }}</td>
                                                        <td style="width: 100px">
                                                            <a class="btn btn-primary fs-14 text-white edit-icn"
                                                                title="Edit"
                                                                href="{{ route('do-phan-giai-man-hinh.cap-nhat', ['id' => $dophangiaimanhinh->id]) }}">
                                                                <i class="fe fe-edit"></i>
                                                            </a>
                                                            <form method="POST" action="{{route('do-phan-giai-man-hinh.xoa',['id'=>$dophangiaimanhinh->id])}}">
                                                                @csrf
