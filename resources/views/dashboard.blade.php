                ...
                <!-- PAGE-HEADER END -->
						...
						<div class="row">
                            <div class="form-group">
                                <label class="form-label" for="default-dropdown">Tháng</label>
                                <select name="month" class="form-control form-select" id="month" data-bs-placeholder="Select Country">
							...
							<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
								<div class="card overflow-hidden">
									<div class="card-body">
										<div class="row">
											<div class="col">
												<h3 class="mb-2 fw-semibold" id="doanh_thu"></h3>
												<p class="text-muted fs-13 mb-0">Doanh thu tháng này</p>
							...
							<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
								<div class="card overflow-hidden">
									<div class="card-body">
										<div class="row">
											<div class="col">
												<h3 class="mb-2 fw-semibold" id="phi_nhap_hang"></h3>
												<p class="text-muted fs-13 mb-0">Tổng phí nhập hàng</p>
							...
							<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
								<div class="card overflow-hidden">
									<div class="card-body">
										<div class="row">
											<div class="col">
												<h3 class="mb-2 fw-semibold" id="don_hang"></h3>
												<p class="text-muted fs-13 mb-0">Đơn hàng trong tháng</p>
							...
							<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
								<div class="card overflow-hidden">
									<div class="card-body">
										<div class="row">
											<div class="col">
												<h3 class="mb-2 fw-semibold" id="luot_dang_ky"></h3>
												<p class="text-muted fs-13 mb-0">Lượt đăng ký thành viên mới</p>
							...
							<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
								<div class="card overflow-hidden">
									<div class="card-body">
										<div class="row">
											<div class="col">
												<h3 class="mb-2 fw-semibold" id="so_luong_ton"></h3>
												<p class="text-muted fs-13 mb-0">Số lượng tồn</p>
							...
							<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
								<div class="card overflow-hidden">
									<div class="card-body">
										<div class="row">
											<div class="col">
												<h3 class="mb-2 fw-semibold" id="so_luong_ban"></h3>
												<p class="text-muted fs-13 mb-0">Số lượng đã bán</p>
							...
							<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
								<div class="card overflow-hidden">
									<div class="card-body">
										<div class="row">
											<div class="col">
												<h3 class="mb-2 fw-semibold" id="don_hang_hoan_thanh"></h3>
												<p class="text-muted fs-13 mb-0">Đơn hàng hoàn thành</p>
							...
							<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
								<div class="card overflow-hidden">
									<div class="card-body">
										<div class="row">
											<div class="col">
												<h3 class="mb-2 fw-semibold" id="tong_thanh_vien"></h3>
												<p class="text-muted fs-13 mb-0">Tổng thành viên</p>
                        ...
                        <div class="col">
                            <h4>Biều đồ đơn hàng và thành viên trong năm</h4>
                        </div>
                        <div class="row my-2">
                        ...
                        <div class="col">
                            <h4>Tổng quan các đơn hàng và số lượng điện thoại của các hãng</h4>
                        </div>
                        <div class="row my-2">
                            <div class="col-md-6 py-1">
                                <div class="card">
...
<script>
    $(document).ready(function() {
        // Khai báo các biến doanh_thu_theo_thang và phi_nhap_hang_theo_thang
        var doanh_thu_theo_thang =[];
        var phi_nhap_hang_theo_thang = [];
        var don_hang_theo_thang = [];
        var luot_dang_ky_theo_thang = [];
        var don_hang_theo_trang_thai = [];
        var so_luong_theo_nha_san_xuat = [];
        var ten_nha_san_xuat = [];
        //lấy tháng năm hiện tại
        var today = new Date();
        var currentMonth = today.getMonth() + 1;
        var currentYear = today.getFullYear();
        //gắn tháng hiện tại cho select
        $('#month').val(currentMonth.toString()); 


        $.ajax({
            url: '{{ route("dashboard-thong-so") }}', 
            method: 'GET',
            data : {
                'month' : currentMonth,
                'year' : currentYear
            ...
            success: function(data) {
                ...
                // Chuyển các giá trị thuộc tính từ dữ liệu JSON thành mảng
                doanh_thu_theo_thang = Object.values(data.doanh_thu_theo_thang);
                phi_nhap_hang_theo_thang = Object.values(data.phi_nhap_hang_theo_thang);
                don_hang_theo_thang = Object.values(data.don_hang_theo_thang);
                luot_dang_ky_theo_thang = Object.values(data.luot_dang_ky_theo_thang);
                don_hang_theo_trang_thai = Object.values(data.don_hang_theo_trang_thai);
                so_luong_theo_nha_san_xuat = Object.values(data.so_luong_theo_nha_san_xuat);
                ten_nha_san_xuat = Object.values(data.ten_nha_san_xuat);
                // Xử lý dữ liệu trả về khi request thành công
                $('#doanh_thu').text(data.doanh_thu); // Cập nhật giá trị doanh thu
                $('#luot_dang_ky').text(data.luot_dang_ky); // Cập nhật giá trị doanh thu
                $('#phi_nhap_hang').text(data.phi_nhap_hang); // Cập nhật giá trị doanh thu
                $('#don_hang').text(data.don_hang); // Cập nhật giá trị doanh thu
                $('#so_luong_ton').text(data.so_luong_ton); // Cập nhật giá trị doanh thu
                $('#so_luong_ban').text(data.so_luong_ban); // Cập nhật giá trị doanh thu
                $('#don_hang_hoan_thanh').text(data.don_hang_hoan_thanh); // Cập nhật giá trị doanh thu
                $('#tong_thanh_vien').text(data.tong_thanh_vien); // Cập nhật giá trị doanh thu
                    //biểu đồ bar
                    ...
                    data: {
                            ...
                            datasets: [
                                {
                                    label: 'Phí nhập hàng',
                                    data: phi_nhap_hang_theo_thang,
                                    backgroundColor: 'rgba(255, 99, 132, 0.5)', // Màu nền của cột 1
                                    borderColor: 'rgba(255, 99, 132, 1)', // Màu viền của cột 1
                                    borderWidth: 1
                                },
                                {
                                    label: 'Doanh thu',
                                    data: doanh_thu_theo_thang,
                                    backgroundColor: 'rgba(54, 162, 235, 0.5)', // Màu nền của cột 2
                                    borderColor: 'rgba(54, 162, 235, 1)', // Màu viền của cột 2
                                    borderWidth: 1
                                }
                            ]
                        },
                        options: {
                            indexAxis: 'x', // Điều chỉnh trục x và y để tạo cột đôi
                            scales: {
                                x: {
                                    beginAtZero: true
                                }
                    ...
                    new Chart(doughnut1, {
                        type: 'doughnut',
                        data: {
                        labels: ['Chưa xác nhận', 'Đã xác nhận', 'Đang vận chuyển', 'Thành công','Đã hủy'],
                        datasets: [{
                            label: 'Trạng thái đơn hàng',
                            data: don_hang_theo_trang_thai,
                            borderWidth: 1,
                        }]
                        },
                        options: {
                    ...
                    type: 'doughnut',
                    data: {
                            labels: ten_nha_san_xuat,
                            datasets: [
                                {
                                    label: 'Số lượng' ,
                                    data: so_luong_theo_nha_san_xuat,
                                    borderWidth: 1
                                },
                            ]
                        },
            ...
            $('#month').on('change',function(){
                var selectedMonth = $(this).val(); // Lấy giá trị của tháng đã chọn
                var selectedYear = today.getFullYear(); // lấy giá trị năm hiện tại;
                $.ajax({
                    url: '{{ route("dashboard-thong-so") }}', 
                    method: 'GET',
                    data : {
