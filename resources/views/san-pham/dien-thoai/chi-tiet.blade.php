                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <div class="btn" style="position: relative;left: 78%;">
                                        <a href="{{ route('dien-thoai.them-moi') }}" class="btn btn-primary-light ">Thêm
                                            mới</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="carousel-inner" id="carousel_hinh_anh">
                                        @foreach ($lst_hinh_anh as $key => $ha)
                                            <div class="carousel-item {{ $key === 0 ? 'active' : '' }}">
                                                <img class="d-block w-100" alt="" src="{{ asset($ha->duong_dan) }}"
                                                    onclick="confirmDelete( {{ $ha->id }} )"
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column">
                                    <form method="POST" class="form-gourp" id="mo_ta_form"
                                        action="{{ route('dien-thoai.cap-nhat-mo-ta', ['id' => $dien_thoai->id]) }}">
                                        @csrf
            ...
            $('#uploadInput').change(function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        formData.append('id', localStorage.getItem(
                        'ID_dien_thoai')); // Thêm ID vào formData
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                carouselInner
                            .empty(); // Xóa nội dung hiện tại của carousel
                                ...
                                $.each(response.lst_hinh_anh, function(key, item) {
                                    ...
                                    ''; // Xác định carousel-item đầu tiên
                                    ...
                                    carouselItem); // Thêm carousel-item vào carousel
                                });
