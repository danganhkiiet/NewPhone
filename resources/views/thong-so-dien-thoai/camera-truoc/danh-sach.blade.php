            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    ...
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('camera-sau.danh-sach') }}">Camera trước</a></li>
                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <div class="btn"  style="position: relative;left: 78%;">
                                        <a href="{{ route('camera-truoc.them-moi') }}" class="btn btn-primary-light ">Thêm mới</a>
                                    </div>
                                    <!-- form tim kiem -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table editable-table table-nowrap table-bordered table-edit">
                                            ...
                                            <tbody>
                                                @foreach ($lst_camera_truoc as $cmrt)
                                                    <tr>
                                                        <td>{{$cmrt->id}}</td>
                                                        <td>{{$cmrt->ten}}</td>
                                                        <td>
                                                            <a class="btn btn-primary fs-14 text-white edit-icn"
                                                                title="Edit" href="{{ route('camera-truoc.cap-nhat',['id' => $cmrt->id]) }}" >
                                                                <i class="fe fe-edit"></i>
                                                            </a>
                                                            <a class="btn btn-danger fs-14 text-white delete-icn"
                                                                title="Delete" href="{{ route('camera-truoc.xoa',['id' => $cmrt->id]) }}" >
