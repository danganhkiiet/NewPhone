            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    ...
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('camera-sau.danh-sach') }}">Chipset</a></li>
                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <div class="btn"  style="position: relative;left: 78%;">
                                        <a href="{{ route('chipset.them-moi') }}" class="btn btn-primary-light ">Thêm mới</a>
                                    </div>
                                    <!-- form tim kiem -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table editable-table table-nowrap table-bordered table-edit">
                                            ...
                                            <tbody>
                                                @foreach ($lst_chipset as $chip)
                                                    <tr>
                                                        <td>{{$chip->id}}</td>
                                                        <td>{{$chip->ten}}</td>
                                                        <td>
                                                            <a class="btn btn-primary fs-14 text-white edit-icn"
                                                                title="Edit" href="{{ route('chipset.cap-nhat',['id' => $chip->id]) }}" >
                                                                <i class="fe fe-edit"></i>
                                                            </a>
                                                            <a class="btn btn-danger fs-14 text-white delete-icn"
                                                                title="Delete" href="{{ route('chipset.xoa',['id' => $chip->id]) }}" >
