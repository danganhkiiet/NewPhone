            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    ...
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('tinh-nang-man-hinh.danh-sach') }}">Tính năng màn hình</a></li>
                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <div class="btn"  style="position: relative;left: 78%;">
                                        <a href="{{ route('tinh-nang-man-hinh.them-moi') }}" class="btn btn-primary-light ">Thêm mới</a>
                                    </div>
                                    <!-- form tim kiem -->
