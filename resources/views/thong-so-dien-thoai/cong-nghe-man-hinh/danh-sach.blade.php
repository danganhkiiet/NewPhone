        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Công nghệ màn hình</h1>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('cong-nghe-man-hinh.danh-sach') }}">Công nghệ màn hình</a></li>
                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <div class="btn"  style="position: relative;left: 78%;">
                                        <a href="{{ route('cong-nghe-man-hinh.them-moi') }}" class="btn btn-primary-light ">Thêm mới</a>
                                    </div>
                                    <!-- form tim kiem -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table editable-table table-nowrap table-bordered table-edit">
                                            ...
                                            <tbody>
                                                @foreach ($lst_cong_nghe_man_hinh as $cnmh)
                                                    <tr>
                                                        <td>{{$cnmh->id}}</td>
                                                        <td>{{$cnmh->ten}}</td>
                                                        <td>
                                                            <a class="btn btn-primary fs-14 text-white edit-icn"
                                                                title="Edit" href="{{ route('cong-nghe-man-hinh.cap-nhat',['id' => $cnmh->id]) }}" >
                                                                <i class="fe fe-edit"></i>
                                                            </a>
                                                            <a class="btn btn-danger fs-14 text-white delete-icn"
                                                                title="Delete" href="{{ route('cong-nghe-man-hinh.xoa',['id' => $cnmh->id]) }}" >
