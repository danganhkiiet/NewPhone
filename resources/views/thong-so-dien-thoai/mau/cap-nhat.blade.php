                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h3 class="card-title">Cập nhật thông tin màu</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="col-md-10 col-lg-8 col-xl-6 mx-auto d-block">
                                                <div class="card card-body pd-20 pd-md-40 border shadow-none">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-label" for="ten">Thông tin màu</label>
                                                        <input class="form-control"  name="ten" id="ten" value="{{$mau->ten }}" type="text" required>
                                                    </div>
