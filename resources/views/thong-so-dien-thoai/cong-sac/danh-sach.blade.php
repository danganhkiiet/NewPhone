                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <div class="btn" style="position: relative;left: 78%;">
                                        <a href="{{ route('cong-sac.them-moi') }}" class="btn btn-primary-light ">Thêm
                                            mới</a>
                                    </div>
                                    <!-- form tim kiem -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table editable-table table-nowrap table-bordered table-edit">
                                            ...
                                            <tbody>
                                                @foreach ($lst_congsac as $congsac)
                                                    <tr>
                                                        <td>{{ $congsac->ten }}</td>
                                                        <td style="width: 100px">
                                                            <a class="btn btn-primary fs-14 text-white edit-icn"
                                                                title="Edit"
                                                                href="{{ route('cong-sac.cap-nhat', ['id' => $congsac->id]) }}">
                                                                <i class="fe fe-edit"></i>
                                                            </a>
                                                            <form method="POST" action="{{route('cong-sac.xoa',['id'=>$congsac->id])}}">
                                                                @csrf
